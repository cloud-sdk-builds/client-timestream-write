...
[`@aws-sdk/client-timestream-write`](https://www.npmjs.com/package/@aws-sdk/client-timestream-write/v/3.620.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-timestream-write@3.620.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gooCz8P2+CEVxISNI4XObe0zsde4NpHZs8/0itHSjew0fKp46yfkrpiF31q/p6is
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-timestream-write": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-timestream-write@3.620.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-timestream-write@3.620.0/index.min.mjs": "sha384-gooCz8P2+CEVxISNI4XObe0zsde4NpHZs8/0itHSjew0fKp46yfkrpiF31q/p6is"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-timestream-write/blob/refs/tags/3.620.0/LICENSE
```
