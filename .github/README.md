...
[`@aws-sdk/client-timestream-write`](https://www.npmjs.com/package/@aws-sdk/client-timestream-write/v/3.525.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-timestream-write@3.525.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5oDajpm4BpESX/irQPJSupKM9fcVLz2CFmWfakTI2dvl2/UYrjpAG9NlQuKAVJCr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-timestream-write": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-timestream-write@3.525.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-timestream-write@3.525.0/index.min.mjs": "sha384-5oDajpm4BpESX/irQPJSupKM9fcVLz2CFmWfakTI2dvl2/UYrjpAG9NlQuKAVJCr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-timestream-write/blob/refs/tags/3.525.0/LICENSE
```
